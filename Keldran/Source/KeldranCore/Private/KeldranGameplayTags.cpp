// Copyright KELDRAN. Native gameplay tag definitions.
#include "KeldranGameplayTags.h"

UE_DEFINE_GAMEPLAY_TAG(Tag_Race_Freeborn, "Race.Freeborn");
UE_DEFINE_GAMEPLAY_TAG(Tag_Class_Warden, "Class.Warden");
...
UE_DEFINE_GAMEPLAY_TAG(Tag_Faction_FreePact, "Faction.FreePact");
UE_DEFINE_GAMEPLAY_TAG(Tag_Faction_Hollow, "Faction.Hollow");
